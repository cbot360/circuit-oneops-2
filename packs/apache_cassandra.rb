...
resource "apache_cassandra",
  :cookbook => "hcf.1.apache_cassandra",
  :design => true,
  :requires => {
      :constraint => "1..1",
  ...
  :payloads => {
    'clouds' => {
      ...
      'definition' => '{
        ...
        "direction": "to",
        "targetClassName": "manifest.hcf.1.Apache_cassandra",
       ...
       :payloads => {
	      'keyspace_clouds' => {
			...
			'definition' => '{
			 ...
			 "relationName": "base.RealizedAs",
			 "direction": "to",
			 "targetClassName": "manifest.hcf.1.Keyspace",
			 "relations": [
			   { "returnObject": false,
			     "returnRelation": false,
			     "relationName": "manifest.Requires",
