  ...
  :payloads => {
    'os' => {
      ...
      'definition' => '{
         ...
         "direction": "to",
         "targetClassName": "manifest.hcf.1.Compute",
         "relations": [
           { "returnObject": true,
             "returnRelation": false,
             "relationName": "manifest.DependsOn",
             "direction": "to",
             "targetClassName": "manifest.hcf.1.Os"
           }
         ]
      }'
    }
...
'environment' => {
    ...
    'definition' => '{
       ...
       "relationName": "base.RealizedAs",
       "direction": "to",
       "targetClassName": "manifest.hcf.1.Fqdn",
       "relations": [
         { "returnObject": false,
           "returnRelation": false,
           "relationName": "manifest.Requires",
             ...
             { "returnObject": false,
               ...
               "relations": [
                 { "returnObject": true,
                   ...
                   "direction": "from",
                   "targetClassName": "cloud.service.hcf.1.Netscaler"
                 },
                 { "returnObject": true,
                   "returnRelation": false,
                   "relationName": "base.Provides",
                 ...
                 { "returnObject": true,
                   ...
                   "relationAttrs":[{"attributeName":"service", "condition":"eq", "avalue":"gdns"}],
                   "direction": "from",
                   "targetClassName": "cloud.service.hcf.1.Route53"
                 },
                 { "returnObject": true,
                   "returnRelation": false,
                   "relationName": "base.Provides",
                   "relationAttrs":[{"attributeName":"service", "condition":"eq", "avalue":"gdns"}],
                   "direction": "from",
                   "targetClassName": "cloud.service.hcf.1.Designate"
                 },
                 { "returnObject": true,
                   "returnRelation": false,
                   "relationName": "base.Provides",
                   "relationAttrs":[{"attributeName":"service", "condition":"eq", "avalue":"gdns"}],
                   "direction": "from",
                   "targetClassName": "cloud.service.hcf.1.Rackspacedns"
                 },
                 { "returnObject": true,
                   "returnRelation": false,
                   "relationAttrs":[{"attributeName":"service", "condition":"eq", "avalue":"gdns"}],
                   "relationName": "base.Provides",
                   "direction": "from",
                   "targetClassName": "cloud.service.hcf.1.Azuretrafficmanager"
                 }
               ]
             }
           ]
...
'organization' => {
 ...
 'lb' => {
    ...
    'definition' => '{
       ...
       "direction": "from",
       "targetClassName": "bom.hcf.1.Lb",
       "relations": [
         { "returnObject": false,
           "returnRelation": false,
           "relationName": "base.RealizedAs",
           "direction": "to",
           "targetClassName": "manifest.hcf.1.Lb",
           "relations": [
             { "returnObject": true,
               "returnRelation": false,
               "relationName": "base.RealizedAs",
                 ...
                 { "returnObject": false,
                   ...
                   { "returnObject": true,
                     ...
                     { "returnObject": true,
                       ...
                       "relationAttrs":[{"attributeName":"service", "condition":"eq", "avalue":"dns"}],
                       "direction": "from",
                       "targetClassName": "cloud.service.hcf.1.Infoblox"
                     }
                   ]
                 }
               ]
  ...
  :payloads => {
    'volumes' => {
     ...
     'definition' => '{
       ...
       "relationName": "base.RealizedAs",
       "direction": "to",
       "targetClassName": "manifest.hcf.1.Storage",
       "relations": [
         { "returnObject": true,
           "returnRelation": false,
           "relationName": "manifest.DependsOn",
           "direction": "to",
           "targetClassName": "manifest.hcf.1.Volume"
         }
       ]
     }'
   }
  ...
  :payloads => {
    'volume_storage' => {
     ...
     'definition' => '{
       ...
       "relationName": "bom.DependsOn",
       "direction": "from",
       "targetClassName": "bom.hcf.1.Storage",
       "relations": [
         { "returnObject": false,
           "returnRelation": false,
...
resource "download",
  :cookbook => "hcf.1.download",
  :design => true,
  :requires => { "constraint" => "0..*" }

resource "daemon",
  :cookbook => "hcf.1.daemon",
  :design => true,
  :requires => { "constraint" => "0..*" },
  :monitors => {
...
resource "sensuclient",
   :cookbook => "hcf.1.sensuclient",
   :design => true,
   :requires => {"constraint" => "0..1"}

resource "firewall",
 :cookbook => "hcf.1.firewall",
 :design => true,
 :requires => {
   "constraint" => "0..1",
   'services' => 'firewall'
 ...
 :payloads => {
   'computes' => {
     ...
     'definition' => '{
       ...
       "relationName": "base.RealizedAs",
       "direction": "to",
       "targetClassName": "manifest.hcf.1.Firewall",
       "relations": [
         { "returnObject": false,
           "returnRelation": false,
           "relationName": "manifest.DependsOn",
           ...
           "relations": [
             ...
             "relationName": "base.RealizedAs",
             "direction": "from",
             "targetClassName": "bom.hcf.1.Compute"
             }
           ]
         }
       ]
...
resource "artifact",
  :cookbook => "hcf.1.artifact",
  :design => true,
  :requires => { "constraint" => "0..*" }

resource "service-mesh",
	:cookbook => "hcf.1.service-mesh",
	:design => true,
	:requires => {
    	"constraint" => "0..1",
