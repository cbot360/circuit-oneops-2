...
resource 'couchbase',
         ...
         :payloads => {
             ...
             'definition' => '{
                ...
                "direction": "to", 
                "targetClassName": "bom.hcf.1.Ring",
                "relations": [ 
                  { "returnObject": false, 
                    "returnRelation": false, 
                    "relationName": "bom.DependsOn", 
                    "direction": "from",
                    "targetClassName": "bom.hcf.1.Couchbase",
                    "relations": [ 
                      {"returnObject": true, 
                       "returnRelation": false, 
                       "relationName": "bom.DependsOn", 
             ...
             'cb_buckets' => {
                 ...
                 "relations": [
                   { "returnObject": true,
                     ...
                     "relationName": "bom.DependsOn",
                     "direction": "to",
                     "targetClassName": "bom.hcf.1.Bucket"
             }
                  ]
               }'
             }
...
resource 'diagnostic-cache',
         :cookbook => 'hcf.1.diagnostic_cache',
         :design => true,
         :requires => {'constraint' => '1..1'},
         :attributes => {
             'username' => 'app',
