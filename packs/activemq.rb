    ...
    :payloads => {
           'activemq' => {
             ...
             :definition  => '{
                ...
                "direction": "from",
                "targetClassName": "bom.hcf.1.Activemq"
              }'
           }
         } ,
   :monitors => {
