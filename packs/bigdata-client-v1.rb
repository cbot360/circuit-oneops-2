...
spark_version = "1"
spark_cookbook = "hcf.1.spark-v#{spark_version}"
yarn_version = "1"
yarn_config_cookbook = "hcf.1.hadoop-yarn-config-v#{yarn_version}"
yarn_cookbook = "hcf.1.hadoop-yarn-v#{yarn_version}"
         ...
         :payloads => {
             'yarnconfigci' => {
                 ...
                 'definition' => '{
                     ...
                     "direction": "to",
                     "targetClassName": "manifest.hcf.1.Hadoop-yarn-v1",
                     "relations": [{
                         "returnObject": true,
                         "returnRelation": false,
                         "relationName": "manifest.DependsOn",
                         "direction": "from",
                         "targetClassName": "manifest.hcf.1.Hadoop-yarn-config-v1"
                     }]
                 }'
             },
             'allFqdn' => {
                     ...
                     "relations": [{
                         ...
                         "relations": [{
                             ...
                             "relations": [{
                                 ...
                                 "relationName": "base.RealizedAs",
                                 "direction": "from",
                                 "targetClassName": "bom.hcf.1.Fqdn"
                             }]
                         }]
                     }]
                 }'
...
resource "spark-cassandra",
         :cookbook => "hcf.1.spark-cassandra-v#{spark_version}",
         :design => true,
         :requires => {
             :constraint => "0..1",
             :services => "dns",
